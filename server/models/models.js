const sequelize = require('../db')          // подключение к базе данных импорты
const { DataTypes } = require('sequelize') // описываються типы полей

//  создание маделей таблиц для хранения данных
